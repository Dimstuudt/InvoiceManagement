...
class ActivityLogger
{
    ...
    public static function actionLabel(string $action): string
    {
        return match ($action) {
            ...
            'invoice.items_updated'     => 'Update item',
            'invoice.totals_updated'    => 'Update total/diskon',
            'invoice.tax_updated'       => 'Update pajak',
            'invoice.frozen'            => 'Bekukan invoice',
            ...
            'invoice.prepay'            => 'Prepay invoice',
            'invoice.restored'          => 'Restore invoice (HEAD carry dihapus)',
            'invoice.reset_all'         => 'Reset semua invoice (demo)',
            // Client
            ...
            'profile.updated'           => 'Update profil',
            'profile.avatar_updated'    => 'Ganti avatar',
            'profile.password_changed'  => 'Ganti password',
            // Master – Bank Account
    ...
    public static function actionGroup(string $action): string
    {
        return match (true) {
            ...
            str_starts_with($action, 'profile.')          => 'auth',
    ...
    public static function allActions(): array
    {
        return [
            ...
            'invoice.reactivated', 'invoice.prepay', 'invoice.restored', 'invoice.reset_all',
            'invoice.carried', 'invoice.resumed', 'invoice.exported',
            'client.created', 'client.updated', 'client.deleted',
            'user.login', 'user.logout', 'user.created', 'user.updated', 'user.deleted',
            'profile.updated', 'profile.avatar_updated', 'profile.password_changed',
