  ...
  <div class="flex h-screen overflow-hidden bg-slate-100">
    ...
    >
      ...
      <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto scroll-dark">
        ...
        <Link :href="route('invoices.index')" :class="navClass(route('invoices.index'), ['/invoices/schedule', '/invoices/clients'])" @click="closeSidebarOnMobile">
          <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <Link :href="route('logs.index')" :class="navClass(route('logs.index'))" @click="closeSidebarOnMobile">
          <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
