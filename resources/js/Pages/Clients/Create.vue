<template>
  <AppLayout title="Tambah Client">
    <div class="max-w-2xl mx-auto">
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <h2 class="text-base font-semibold text-gray-800 mb-5">Data Client Baru</h2>
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <!-- NPWP Image -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">NPWP Image <span class="text-gray-400 font-normal">(opsional)</span></label>
            <ImageUpload :error="form.errors.npwp_image" @change="form.npwp_image = $event" />
          </div>
