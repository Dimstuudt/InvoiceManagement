<template>
  <AppLayout title="Tambah Client Category">
    <div class="max-w-xl mx-auto">
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <h2 class="text-base font-semibold text-gray-800 mb-5">Tambah Client Category</h2>
...
function submit() { form.post(route('master.client-categories.store')); }
</script>
