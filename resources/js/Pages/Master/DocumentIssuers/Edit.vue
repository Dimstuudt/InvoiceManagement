  ...
  <AppLayout title="Edit Document Issuer">
    <div class="max-w-xl">
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <h2 class="text-base font-semibold text-gray-800 mb-5">Edit Document Issuer</h2>
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">Header Image</label>
          ...
          <div>
            ...
            <input v-model="form.tax_id_number" type="text" class="w-full px-4 py-2.5 rounded-lg border text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" :class="form.errors.tax_id_number ? 'border-red-400' : 'border-gray-300'" />
...
function submit() {
  form.post(route('master.document-issuers.update', props.issuer.id), { _method: 'put' });
}
</script>
