      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div>
            ...
            <input v-model="form.code" type="text" class="w-full px-4 py-2.5 rounded-lg border text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" :class="form.errors.code ? 'border-red-400' : 'border-gray-300'" placeholder="e.g. PRJ-001" />
...
const form = useForm({ name: '', code: '', description: '', company_id: '' });
function submit() { form.post(route('master.project-categories.store')); }
</script>
