      ...
      <form @submit.prevent="submit">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-900">Tambah Signature</h2>
            <p class="text-sm text-gray-400 mt-0.5">Tambahkan tanda tangan untuk dokumen invoice</p>
          </div>
          ...
          <div class="px-6 py-6 space-y-6">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input v-model="form.position" type="text" placeholder="e.g. Direktur Utama"
                  class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
