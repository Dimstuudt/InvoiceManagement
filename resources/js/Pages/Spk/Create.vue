    ...
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-gray-400 mt-0.5">Upload PDF SPK — AI akan mengisi data klien & kontrak otomatis</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm flex overflow-hidden" style="min-height: 600px;">
          ...
          <div class="p-4 border-b border-gray-50">
            <div
              ...
              <template v-else-if="parsing">
                ...
                <p class="text-[10px] text-amber-400 mt-0.5">mengekstrak data klien & kontrak</p>
              </template>
        ...
        <div class="w-3/5 flex flex-col">
          <div class="flex-1 overflow-y-auto p-5 space-y-5">
            ...
            <!-- Klien Baru -->
            <div>
              <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-3">Data Klien Baru</p>
