  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <div class="w-full max-w-sm card-enter">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <!-- Accent strip -->
        <div class="h-1 bg-gradient-to-r from-sky-500 to-blue-400"/>

        <div class="p-8">
          <!-- Shield -->
          <div class="flex justify-center mb-5">
            <div class="w-14 h-14 rounded-2xl bg-sky-50 border border-sky-100 flex items-center justify-center">
          ...
          <form @submit.prevent="submit">
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  class="w-px h-5 bg-sky-500 cursor-blink"
                />
              </div>
            ...
            <button
              ...
              :class="form.code.length === 6 && !form.processing
                ? 'bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white shadow-lg shadow-sky-100'
...
function boxStyle(i) {
  ...
  if (active)  return 'border-sky-500 bg-white text-slate-900 shadow-[0_0_0_3px_rgba(14,165,233,0.12)]'
  if (filled)  return 'border-sky-300 bg-sky-50 text-slate-900'
